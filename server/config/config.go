...
func initViper() (Constants, error) {
	...
	if os.Getenv("ENVIRONMENT") == "DOCKER" {
		viper.SetConfigName("unity_project_docker.config") // Configuration fileName without the .TOML or .YAML extension
	} else {
		viper.SetConfigName("unity_project.config") // Configuration fileName without the .TOML or .YAML extension
	}
